      ...
      endDrawer: Drawer(
        ...
        child: ListView(children: <Widget>[
          ListTile(
            ...
            title:
                Text('My profile', style: TextStyle(color: Color(0xff909699))),
            onTap: () {
          ...
          ListTile(
            ...
            title:
                Text('My library', style: TextStyle(color: Color(0xff909699))),
            onTap: () {
          ...
          ListTile(
            ...
            title: Text('Settings', style: TextStyle(color: Color(0xff909699))),
            onTap: () {
          ...
          ListTile(
            ...
            title: Text('Log-out', style: TextStyle(color: Color(0xff909699))),
            onTap: () {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              '    # ${tagGroups(groupName: 'brain', contacts: []).groupName}',
              style: TextStyle(color: Color(0xff909699)),
            ),
            Text(
              '    # ${tagGroups(groupName: 'Lungs', contacts: []).groupName}',
              style: TextStyle(color: Color(0xff909699)),
            ),
            Padding(
              padding: const EdgeInsets.all(10),
            ...
            Text(
              '- ${contact(name: 'Eyal Zawlik').name}',
              style: TextStyle(color: Color(0xff909699)),
            ),
            Text(
              '- ${contact(name: 'Nadav Benoudiz').name}',
              style: TextStyle(color: Color(0xff909699)),
            ),
            Text(
              '- ${contact(name: 'Nadav Morag').name}',
              style: TextStyle(color: Color(0xff909699)),
            ),
          ],
        ),
